			...
			<div class="row">
				...
				<div class="col-md-6 form_wrapper">				
					...
					<textarea class="form-control custom_input" rows="10" placeholder="Your Enquiry"></textarea>
					  <button type="submit" class="btn btn-success btn-lg pull-right btn-submit">SUBMIT ENQUIRY</button>
					</form>
